...
public class TileManager {
    ...
    public void loadMap(){ //Escanea linea a linea el archivo map y mete los numeros en el array mapTileNum
    ...
    public void draw(Graphics2D g2){
        ...
        while(col < gp.maxScreenCol && row < gp.maxScreenRow){
            ...
            int tileNum = mapTileNum[col][row]; //Toma un numero del array
